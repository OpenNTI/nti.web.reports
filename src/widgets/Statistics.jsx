	...
	renderContent () {
		...
		return (
			<div className="statistics-content">
				...
				{progressStats && this.renderValueSection(t('studentsCompleted'), progressStats.CountCompleted)}
				{progressStats && this.renderValueSection(t('studentsWithProgress'), progressStats.CountHasProgress)}
			</div>
		);
	}
